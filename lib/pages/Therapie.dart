...
import 'package:pcd/therapiepages/therapist.dart';
import 'package:pcd/therapiepages/alimentation.dart';
import 'package:pcd/therapiepages/sommeil.dart';
import 'package:pcd/therapiepages/relaxation.dart';
import 'package:pcd/therapiepages/chatbott.dart';

class Therapie extends StatefulWidget {
  const Therapie({super.key});

  @override
  State<Therapie> createState() => _TherapieState();
}

class _TherapieState extends State<Therapie> {
  @override
